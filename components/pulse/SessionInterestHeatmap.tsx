...
export default function SessionInterestHeatmap({
  ...
  if (!heat.halls.length || !heat.times.length) {
    return (
      <section className="pulse-panel absolute flex flex-col overflow-hidden p-3" style={{ left: 804, top: 538, width: 508, height: 319, backgroundImage: "url('/pulse/bg-geo.png')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
